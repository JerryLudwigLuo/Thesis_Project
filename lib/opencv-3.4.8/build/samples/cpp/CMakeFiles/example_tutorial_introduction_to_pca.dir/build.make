...
bin/example_tutorial_introduction_to_pca: lib/libopencv_videostab.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_shape.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_ml.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_objdetect.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_highgui.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_stitching.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_dnn.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_calib3d.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_features2d.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_photo.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_superres.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_viz.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_flann.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_videoio.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_imgcodecs.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_video.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_imgproc.so.3.4.8
bin/example_tutorial_introduction_to_pca: lib/libopencv_core.so.3.4.8
bin/example_tutorial_introduction_to_pca: samples/cpp/CMakeFiles/example_tutorial_introduction_to_pca.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable ../../bin/example_tutorial_introduction_to_pca"
	cd /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build/samples/cpp && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/example_tutorial_introduction_to_pca.dir/link.txt --verbose=$(VERBOSE)
...
samples/cpp/CMakeFiles/example_tutorial_introduction_to_pca.dir/clean:
	cd /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build/samples/cpp && $(CMAKE_COMMAND) -P CMakeFiles/example_tutorial_introduction_to_pca.dir/cmake_clean.cmake
...
samples/cpp/CMakeFiles/example_tutorial_introduction_to_pca.dir/depend:
	cd /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8 /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/samples/cpp /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build/samples/cpp /home/jerryluo/Learn/Thesis_Project/lib/opencv-3.4.8/build/samples/cpp/CMakeFiles/example_tutorial_introduction_to_pca.dir/DependInfo.cmake --color=$(COLOR)
